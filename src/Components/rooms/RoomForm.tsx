...
function RoomForm(props?: RoomFormProps) {
    ...
    return (
        <div className="container mx-auto">
            <h1 className="text-2xl font-bold mb-4">{createRoom ? 'Create a new room' : 'Edit room'}</h1>
            <form onSubmit={handleCreateRoom}>
                ...
                <div className="flex flex-col mb-4">
                    ...
                    <SelectInput options={typeOptions} onChange={handleTypeInputChange} value='' name='type' />
                </div>
                <div className="flex flex-col mb-4">
                    <label htmlFor="type" className="mb-2 font-bold">
                        Status
                ...
                <PrimaryButton type="submit" onClick={()=>console.log('submit')}>
                    {createRoom ? 'Create Room' : 'Edit Room'}
                </ PrimaryButton>
            </form>
        </div>
    );
